...
//   const student = new Student("Сулайманкулов", "Акбар", 2021);
...
class Cleaning {
do() {
    console.log('отец сказал помыть машину');
}
}

class FirstSon extends Cleaning {
do() {
    console.log('помыть колёса');
}
}

class SecondSon extends Cleaning {
do() {
    console.log('Пропылесосыть салон');
}
}